...
(() => {
  const CARD_LIBRARY = {
    ...
    11: { id: 11, name: "キメラ・スパイダー", cost: 2, hp: 3000, at: 1000, effect: "この効果はバトル中に1度だけ発動可能。このモンスターが破壊された時、手札かサブアタッカーに『スモール・スパイダーズ』がいる場合、そのカードを種ゾーンの手前に置く。", effectCode: "SPIDER_SEED_ON_DESTROY", limit: "battle", accent: "#394e3b", art: "monster_card_illust/kimera_spider.png" },
